    ...
    <footer className="bg-[#F6F6F7] py-16">
      <div className="container m-auto">
        <div className="flex">
          ...
          <div className="flex-1 flex flex-col gap-4 text-[#3B3C4A] items-center">
            <a href="#home">Home</a>
            <a href="#blog">Blog</a>
        ...
        <div className="flex justify-between items-center border-t-[1px] mt-[25px] pt-4">
          <div className="flex items-center gap-x-2">
            <img className="" src="./images/mainlogo.png" alt="" />
            <div>
              <div>
                <span>Blog</span>
